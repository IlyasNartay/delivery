...
SECRET_KEY = 'django-insecure-se1xy)t^e%d50d74+f@3=*+jg388g$^v3ygdi&a!mr0@gxl#5v'
...
# -- Настройка Simple JWT (необязательно, для кастомизации) --
...
SIMPLE_JWT = {
    ...
    # Можно включить/выключить другие параметры
}
